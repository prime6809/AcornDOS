...
$DFSDISK write "$SSD" -f "$DOSVER"/BACKUP.DFS -q \$20 -l \$2900 -e \$2900
$DFSDISK write "$SSD" -f "$DOSVER"/COMPACT.DFS -q \$20 -l \$2900 -e \$2900
$DFSDISK write "$SSD" -f "$DOSVER"/COPY.DFS -q \$20 -l \$2900 -e \$2900
$DFSDISK write "$SSD" -f "$DOSVER"/COPYF.DFS -q \$20 -l \$2900 -e \$2900
$DFSDISK write "$SSD" -f "$DOSVER"/DUTY.DFS -q \$20 -l \$2900 -e \$2900
if [ $DOSVER != "dos1770" ]
then
$DFSDISK write "$SSD" -f "$DOSVER"/FORM40.DFS -q \$20 -l \$2900 -e \$2900
$DFSDISK write "$SSD" -f "$DOSVER"/FORM80.DFS -q \$20 -l \$2900 -e \$2900
$DFSDISK write "$SSD" -f "$DOSVER"/VERIFY4.DFS -q \$20 -l \$2900 -e \$2900
$DFSDISK write "$SSD" -f "$DOSVER"/VERIFY8.DFS -q \$20 -l \$2900 -e \$2900
fi
$DFSDISK write "$SSD" -f "$DOSVER"/SYSINFO.DFS -q \$20 -l \$2900 -e \$2900
